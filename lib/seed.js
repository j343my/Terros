...
export const SEED_BACS = [
  { id: "bac-1", nom: "Grand bac tomates", dimensions: "100×40", volume: "80", exposition: "Sud-Est", emplacement: "exterieur", notes: "Contre le mur principal, plein soleil de 7h à 14h. Idéal pour les tomates." },
  { id: "bac-2", nom: "Bac aromatiques", dimensions: "60×25", volume: "20", exposition: "Sud-Est", emplacement: "exterieur", notes: "À portée de main depuis la porte. Basilic, thym, ciboulette, persil." },
  { id: "bac-3", nom: "Bac salades & radis", dimensions: "80×30", volume: "35", exposition: "Sud-Est", emplacement: "exterieur", notes: "Semis successifs toutes les 3 semaines pour étaler les récoltes." },
  { id: "bac-4", nom: "Pot courgette", dimensions: "45×45", volume: "40", exposition: "Sud-Est", emplacement: "exterieur", notes: "Un seul pied — une courgette occupe beaucoup de place. Arrosage quotidien en été." },
  { id: "bac-5", nom: "Pot poivrons & aubergine", dimensions: "50×30", volume: "30", exposition: "Sud-Est", emplacement: "exterieur", notes: "Contre le mur pour profiter de la chaleur réfléchie. Adore la chaleur accumulée en SE." },
];
